...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.blob'
        db.alter_column(u'games_asset', 'blob', self.gf('django.db.models.fields.files.FileField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Asset.blob'
        db.alter_column(u'games_asset', 'blob', self.gf('django.db.models.fields.files.FileField')(max_length=100))
