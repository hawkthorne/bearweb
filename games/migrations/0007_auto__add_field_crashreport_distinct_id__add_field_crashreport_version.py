...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrashReport.distinct_id'
        db.add_column(u'games_crashreport', 'distinct_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=24),
                      keep_default=False)

        # Adding field 'CrashReport.version'
        db.add_column(u'games_crashreport', 'version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=14),
                      keep_default=False)

        # Adding field 'CrashReport.os'
        db.add_column(u'games_crashreport', 'os',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=14),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrashReport.distinct_id'
        db.delete_column(u'games_crashreport', 'distinct_id')

        # Deleting field 'CrashReport.version'
        db.delete_column(u'games_crashreport', 'version')

        # Deleting field 'CrashReport.os'
        db.delete_column(u'games_crashreport', 'os')
