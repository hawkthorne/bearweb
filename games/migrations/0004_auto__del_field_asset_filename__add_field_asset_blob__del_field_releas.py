...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.filename'
        db.delete_column(u'games_asset', 'filename')

        # Adding field 'Asset.blob'
        db.add_column(u'games_asset', 'blob',
    ...
    def backwards(self, orm):
        # Adding field 'Asset.filename'
        db.add_column(u'games_asset', 'filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Deleting field 'Asset.blob'
        db.delete_column(u'games_asset', 'blob')
