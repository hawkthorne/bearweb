...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.love_version'
        db.add_column(u'games_release', 'love_version',
                      self.gf('django.db.models.fields.CharField')(default='0.8.0', max_length=14),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.love_version'
        db.delete_column(u'games_release', 'love_version')
